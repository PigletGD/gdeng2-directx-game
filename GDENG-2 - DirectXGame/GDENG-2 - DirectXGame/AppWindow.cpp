...
{
	if (key == 'W') m_rot_x += 3.14f * m_delta_time;
	else if (key == 'S') m_rot_x -= 3.14f * m_delta_time;
	else if (key == 'A') m_rot_y += 3.14f * m_delta_time;
	else if (key == 'D') m_rot_y -= 3.14f * m_delta_time;
}

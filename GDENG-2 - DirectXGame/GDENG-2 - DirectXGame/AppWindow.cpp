...
void AppWindow::initialize()
{
	...
	this->objectListSharedPtr.push_back(m_mesh);
	...
	*/
	...
	render_system->compileVertexShader(L"VertexShader.hlsl", "vsmain", &shader_byte_code, &size_shader);
...
//	m_object_list.push_back(cube_object);
	...
	render_system->compilePixelShader(L"PixelShader.hlsl", "psmain", &shader_byte_code, &size_shader);
